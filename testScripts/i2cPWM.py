...
class ncp5623:
  def __init__(self):
      ...
      self.pwm2Address = 0x60 #96 #0x60 #pwm2 and pwm3 are connected in parallel in order to provide more current
    ...
    if(0):
        for i in range(10):
            for dc in range(0, 101, 5):    # Loop 0 to 100 stepping dc by 5 each loop
                ...
                time.sleep(0.2)             # wait .05 seconds at current LED brightness
                print(dc)
